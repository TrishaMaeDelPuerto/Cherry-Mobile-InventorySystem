...
<body>
  <?php if($results): ?>
    <div class="page-break">
       <div class="sale-head">
           <h1>Acel's Menu- Sales Report</h1>
  ...
  <form method="post" action="excel.php">
    <input type="submit" id ="btnPrint" name="export_excel" class="but-excel" value="Export to Excel"/>
    </form>  
    <form method="post" onclick=">
    //<input type="submit" name="export_pdf" class="but-excel" value="Create PDF file"/>
    </form>
    <button class="back" id="btnPrint" onclick="window.print()">Print & Save</button> 
    <form method="post" action="home.php">
    <button name="back" id ="btnPrint" class="back">Back to Homepage
    </form>  
    </form> 
</body>
</html>
